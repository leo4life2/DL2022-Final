...
def train(opt):
    ...
    model = torch.load("/home/leo/Desktop/DL2022/Flappy-bird-deep-Q-learning-pytorch/trained_models/fireball_flappy_bird_1118166")
    ...
    try:
        while iter < opt.num_iters:
            ...
            if (iter+1) % 1000000 == 0:
                torch.save(model, "{}/fireball_flappy_bird_{}".format(opt.saved_path, iter+1))
    except KeyboardInterrupt:
        print("Saving model before quit")
        torch.save(model, "{}/fireball_flappy_bird_{}".format(opt.saved_path, iter+1))

    torch.save(model, "{}/fireball_flappy_bird".format(opt.saved_path))
